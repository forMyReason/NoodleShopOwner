...
-   **但PE = 35倍，ROE = 140%**：虽然你花100块只买到2.48块的家底，但这2.48块的家底一年能赚2.84块。**你用100块，买的是一个每年能赚2.84块的“赚钱机器”**——回本需要35年（PE=35）。
...
-   ROE极高（>140%）说明它极度依赖“无形资产”赚钱——如果品牌或生态出现问题，利润会迅速崩塌，而账面上几乎没有“家底”可以兜底。
